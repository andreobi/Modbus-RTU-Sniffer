...
The Software uses the standard wireless connection via wlan access or local accesspoint. There is no Security implemented to access the Sniffer Server. Also the Web Socket connection and data exchange is open to the connected network. When the ESP is operated as an Access Point, there is only one client who can connect to the ESP.

The sniffer provides (please tae a look at the Modbus Sniffer.pdf)
...
The software was developed under arduino with some help of Google-KI. So neither Google nor I will take responibility or any relaiabilty for the code.
